...
from account.views import (register_view, logout_view, login_view, account_view, need_authentication_view)

urlpatterns = [
    path('blogpost/', include('blogpost.urls', 'blogpost')),
    ...
    path('need_authentication/', need_authentication_view, name="need_authentication"),
